...
import L_vernost from "../../assets/img/experience/vernost.jpeg";
import L_gupshup from "../../assets/img/experience/gupshup.jpeg";
          ...
          <Tilt options={{ max: 25 }}>
            <Card>
              <Card.Header as="h5" className="d-flex justify-content-center flex-wrap">
                <Card.Img variant="top" className="img-resize" src={L_vernost} alt="Accenture logo" />
              </Card.Header>
            ...
            <Card>
              <Card.Header as="h5" className="d-flex justify-content-center flex-wrap">
                <Card.Img variant="top" className="img-resize" src={L_gupshup} alt="Accenture logo" />
              </Card.Header>
              <Card.Body className="d-flex justify-content-center flex-column">
                <div>
